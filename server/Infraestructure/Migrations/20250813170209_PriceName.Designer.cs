...
namespace Infraestructure.Migrations
{
    ...
    [Migration("20250813170209_PriceName")]
    partial class PriceName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Inventory.Product", b =>
                {
                    ...
                    b.ToTable("Productos", null, t =>
                        {
                            t.HasCheckConstraint("CK_PrecioStock_Positivos", "[Precio] > 0 AND [Stock] > 0");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sales.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = new Guid("ca164733-6a40-43c0-8dfd-3a77c0be5924"),
